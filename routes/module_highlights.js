...
// mimics highlights of basic in-progress course with multiple students
...
// mimics response when only one student has crossed in from LMS
router.get('/solo_student', (req, res) => {
  const data = {
    course_outcome_proficiencies: [
      {
        label: 'List steps of the statistical investigative process',
    ...
    quiz_summary: {
      percent_above_mastery: 40,
      percent_average_score: 40
    }
  };
...
// mimics response before any students have crossed in from LMS
router.get('/no_students', (req, res) => {
  const data = {
    course_outcome_proficiencies: [
      {
        label: 'List steps of the statistical investigative process',
    ...
    quiz_summary: {
      percent_above_mastery: 0,
      percent_average_score: null
    }
  };
